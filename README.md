...
|---|--------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|---------------|---------|
|   | Low Risk                                                     | {<br>"income": 8500,<br>"debt": 500,<br>"age": 25,<br>"employed": true,<br>"loanAmount": 1500,<br>"loanPeriod": 12<br>}  |
|   | Medium Risk (less income)                                    | {<br>"income": 3000,<br>"debt": 500,<br>"age": 25,<br>"employed": true,<br>"loanAmount": 1500,<br>"loanPeriod": 12<br>}  |
|   | High Risk (less income,high debt,unemployed and less period) | {<br>"income": 1000,<br>"debt": 1500,<br>"age": 25,<br>"employed": false,<br>"loanAmount": 1500,<br>"loanPeriod": 6<br>} |
|   | Very High Risk                                               | {<br>"income": 100,<br>"debt": 500,<br>"age": 25,<br>"employed": true,<br>"loanAmount": 500,<br>"loanPeriod": 12<br>}    |
|   | Invalid (Age < 16)                                           | {<br>"income": 8500,<br>"debt": 500,<br>"age": 13,<br>"employed": false,<br>"loanAmount": 1500,<br>"loanPeriod": 12<br>} | 400 Bad Request (age must be greater than 16)   |
|   | Invalid (Income = 0)                                         | {<br>"income": 0,<br>"debt": 500,<br>"age": 25,<br>"employed": true,<br>"loanAmount": 1500,<br>"loanPeriod": 12<br>}     | 400 Bad Request (income must be greater than 0) |
